...
/// <summary>
///   A repository that provides basic operations to entities.
/// </summary>
/// <typeparam name="TEntity">The type of the entity.</typeparam>
public interface IAsyncRepository<TEntity> : IReadOnlyAsyncRepository<TEntity> where TEntity : Entity, new() {
  /// <summary>
  ...
  Task DeleteAsync(IEnumerable<Guid> identifiers, CancellationToken cancellationToken = default);
